...
/* harmony import */ var _modules_init_parallax__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-parallax */ "./js/modules/init-parallax.js");
/* harmony import */ var _modules_toggle_mobile_menu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/toggle-mobile-menu */ "./js/modules/toggle-mobile-menu.js");
/* harmony import */ var _modules_init_sliders__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-sliders */ "./js/modules/init-sliders.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_init_parallax__WEBPACK_IMPORTED_MODULE_2__["initParallax"])();
  Object(_modules_toggle_mobile_menu__WEBPACK_IMPORTED_MODULE_3__["toggleMobileMenu"])();
  Object(_modules_init_sliders__WEBPACK_IMPORTED_MODULE_4__["initSliders"])(); // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
...
var initSliders = function initSliders() {
  var sliderBlocks = document.querySelectorAll('.js-slider-block');
  ...
  sliderBlocks.forEach(function (item) {
    var swiperBlock = item.querySelector('.swiper');
...
/***/ "./js/modules/toggle-mobile-menu.js":
/*!******************************************!*\
  !*** ./js/modules/toggle-mobile-menu.js ***!
  \******************************************/
...
var toggleMobileMenu = function toggleMobileMenu() {
  var burgerBtn = document.querySelector('.js-burger-btn');
  ...
  var closeBtn = mobileMenu.querySelector('.js-close-btn');
